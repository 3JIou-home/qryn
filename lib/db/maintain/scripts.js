...
-- For check qryn server after restart
SELECT argMax(name, inserted_at) as _name,
        argMax(value, inserted_at) as _value
        FROM qryn.settings WHERE fingerprint IN (990984054,4103757074,3425380085,1554871379,2800872762) GROUP BY fingerprint HAVING _name != '';
select * from qryn.ver;
--  For restore qryn server after db changes
INSERT INTO qryn.settings(fingerprint, type, name, value, inserted_at) VALUES (4103757074, 'rotate', 'v3_time_series_days', '7', now());
INSERT INTO qryn.settings(fingerprint, type, name, value, inserted_at) VALUES (-3893550587615109346, 'update', 'v3_1', '1674796141', now());
INSERT INTO qryn.settings(fingerprint, type, name, value, inserted_at) VALUES (1554871379, 'rotate', 'v1_traces_days', '7', now());
INSERT INTO qryn.settings(fingerprint, type, name, value, inserted_at) VALUES (990984054, 'rotate', 'v3_samples_days', '7', now());
INSERT INTO qryn.ver(k, ver) VALUES (2, 8);
INSERT INTO qryn.ver(k, ver) VALUES (1, 10);
